...
**Implementation:** `src/core/topology_echo.py`, `src/core/certify_topology.py`, `veyra_sage/topology_echo.py`.  
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_topology_echo.py tests/test_veyra_sage_topology_echo.py tests/test_certify.py tests/test_veyra_sage.py

...
**Implementation:** `src/core/likelihood_geometry.py`, `src/core/certify_likelihood.py`, `veyra_sage/likelihood_geometry.py`.  
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_likelihood_geometry.py tests/test_veyra_sage_likelihood_geometry.py tests/test_certify.py tests/test_veyra_sage.py

...
**Implementation:** `src/core/quantum_circuit_compression.py`, `src/core/certify_quantum_compression.py`.
...
```bash
PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=. python3 -m pytest -q tests/test_quantum_circuit_compression.py tests/test_quantum_baselines.py tests/test_certify.py

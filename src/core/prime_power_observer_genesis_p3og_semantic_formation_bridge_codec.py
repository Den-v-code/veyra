"""Domain-separated digests for the current P3-OG semantic-formation bridge."""
...
DOMAIN = b"veyra-p3og-semantic-formation-bridge-v2\0"
_EVIDENCE = frozenset({
...
def semantic_formation_bridge_digest(label: str, *values: Any) -> str:
    """Hash one bridge value under its isolated current semantic domain."""

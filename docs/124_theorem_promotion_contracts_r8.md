...
is in [doc 125](125_intrinsic_mode_transport_r9.md); R10's closed recurrence
surface, generic image semantics, 37-source/ten-stage source/object/runtime trust boundary, and
Python-parser TCB are in [doc 126](126_proof_grade_core_elaboration_r10.md).
...
`tests/test_layer_theorem_contracts.py` reproduces the old false-promotion edit and checks rejection of:

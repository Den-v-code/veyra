...
from .essence import core_layers
...
from .layer_derivations import META_LAYERS, SHADOW_LAYERS, WITNESS_SOURCES
...
def certify_intrinsic_observer_echo_r13() -> Certificate:
    ...
    try:
        ...
        logger.exception("certify_intrinsic_observer_echo_r13 blocked")

...
**Implementation:** `src/core/formal_export_{catalog,geometry_data,remaining_data,completion,remaining_completion}.py`, `src/core/certify_formal_completion.py`.
...
PYTHONPATH=. python3 -m pytest -q tests/test_formal_export_remaining_artifacts.py tests/test_formal_export_remaining_completion.py tests/test_formal_export_completion.py tests/test_formal_export_evaluator.py tests/test_formal_export_geometry_wave.py tests/test_formal_export_probability_union.py tests/test_formal_export_probability_independence.py tests/test_formal_export_binomial_symmetry.py tests/test_formal_export_variance_shift.py tests/test_formal_export_prep.py
PYTHONPATH=. python3 -c 'from src.core.certify_formal_completion import certify_formal_export_completion_x8 as c; assert c().passed'
```

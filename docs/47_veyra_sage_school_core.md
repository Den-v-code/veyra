...
|---|---|---|
| `VeyraTheoremSpec` | Sage-facing immutable theorem wrapper | `src/core/theorem_registry.py` |
| `VeyraCurriculumNode` | Sage-facing curriculum wrapper | `src/core/curriculum_map.py` |
| `VeyraExportRow` | JSON-ready theorem/curriculum bridge row | `src/core/depth_packs.py` |
...
- `tests/test_veyra_sage_school.py` — facade summary, lookup, export rows.
- `tests/test_veyra_sage.py` — certificate suite now includes `sage_school_passed`.

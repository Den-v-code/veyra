...
from .all_depth_family_common import reject
from .all_depth_family_digest import judgment_digest as make_judgment_digest
from .all_depth_family_formal import FormalFamilySource
from .all_depth_family_ledger import snapshot_assumption_ledger
from .all_depth_family_sources import (
...
from .productivity_types import ProductiveProcessSource
...
def derive_periodic_family(
    ...
    from .all_depth_family_result_validation import validate_derived_family_judgment
...
def admit_supplied_family(
    ...
    from .all_depth_family_result_validation import validate_supplied_family_judgment
...
def admit_oracle_family(
    ...
    from .all_depth_family_result_validation import validate_oracle_family_judgment
...
def open_all_depth_family(
    ...
    from .all_depth_family_result_validation import validate_open_family_judgment

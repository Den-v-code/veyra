...
Implemented in `src/core/geometry_relations.py`:
...
Tests in `tests/test_geometry_relations.py` verify congruent corridors, shell membership, triangle congruence with mirror obstruction, parallel certificates, translations, quarter-turns, and scaling of separation.

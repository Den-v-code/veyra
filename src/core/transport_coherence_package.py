...
import logging
from .generated_confluence_paths import branch_targets, generated_local_peaks
from .generated_confluence_source import snapshot_ranked_system
from .generated_confluence_types import RankedContinuationSystem
from .transport_coherence_common import digest, exact_digest, exact_shape, exact_text, reject
from .transport_coherence_paths import replay_path
from .transport_coherence_source import HARD_CANONICAL_BYTES, HARD_MAP_ENTRIES, HARD_VALUES, snapshot_transport_doctrine
...
def transport_package(
    ...
    from .transport_coherence_ledger import snapshot_ledger
...
def _snapshot_theorem(raw: TransportTheoremSource) -> TransportTheoremSource:
    ...
    from .transport_coherence_formal import transport_theorem_source

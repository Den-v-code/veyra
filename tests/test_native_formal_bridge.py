...
def test_native_semantics_are_checked_generally_in_lean():
    ...
    arithmetic_source = Path("proofs/lean/VeyraNativeArithmetic.lean").read_text(encoding="utf-8")
...
def test_python_echo_mismatch_matches_the_named_lean_obstruction_law():
    ...
    lean_source = Path("proofs/lean/VeyraNativeSemantics.lean").read_text(encoding="utf-8")

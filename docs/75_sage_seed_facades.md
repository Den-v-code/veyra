...
2026-06-06: geometry theorem-card exports are now handled separately in `docs/80_geometry_sage_exports.md`; the current generated notebook artifact summary is 41 notebooks, 280 cells, 133 markdown cells, and 147 code cells after the likelihood geometry notebook.

...
from .positive_ontology_response import observation_data, response_modalities
from .positive_ontology_observer import snapshot_observer_program
...
def continuation_witness(
    ...
    from .positive_ontology_validation import snapshot_continuation_witness

...
| `THM_TR1_001_reaches_monotone` | `theorem` | `FORMALLY_PROVED` | same-module definitions only | `proofs/lean/VeyraObserverLattice.lean:11` |
...
The 94 declarations (48 headlines) in `experimental/research_lean/manifest.json`
...
T008 adds a current-executable literal checkpoint independently cross-checked by
fresh Python complete-history replay; it does not establish Python-byte
implementation equivalence, full DEF-OG-009, `EndogenousArithmeticObserverRole`,
HAP/N0, or THM-P3OG-001/003.

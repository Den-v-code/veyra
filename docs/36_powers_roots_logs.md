...
`docs/86_scale_memory_log.md` upgrades `DEF-067` into practical recovery certificates: exact transition-depth recovery, residual logs, cyclic unwraps, and explicit obstructions.

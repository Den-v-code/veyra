...
Implemented in `src/core/depth_packs.py`:
...
Tests in `tests/test_depth_packs.py` verify combinatorics counts, probability union, independence, variance shift, and Sage export rows.

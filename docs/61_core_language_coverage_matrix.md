...
PYTHONDONTWRITEBYTECODE=1 python3 -m pytest -q \
  tests/test_core_language_coverage.py tests/test_core_language_property_fuzz.py \
  tests/test_core_language_generated_fuzz.py tests/test_core_language_fuzz.py \

"""Reviewed deterministic Lean object records for the exact R11 chain."""
from types import MappingProxyType

_EXPECTED_LEAN_OBJECT_ROWS = (
    ("lean_arithmetic", (
...
EXPECTED_LEAN_OBJECTS = MappingProxyType(dict(_EXPECTED_LEAN_OBJECT_ROWS))

...
_EXPECTED_R11_TCB_DIGEST_ROWS = (
    ...
    ("r10_manifest", "145df0ebd06140f234963196cddea4520668470aaea4aba5f4c93b2f132106bb"),
    ...
    ("lean_export", "aa5b1f20db074ca16acb7245f8e40388160a6e646b27689cbbdc7f6d39a0ddf9"),
)

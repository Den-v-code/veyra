...
def validate_derived_family_judgment(
    ...
    from .all_depth_family_runtime import _derive_periodic_family
...
def validate_supplied_family_judgment(
    ...
    from .all_depth_family_runtime import _admit_supplied_family
...
def validate_oracle_family_judgment(
    ...
    from .all_depth_family_runtime import _admit_oracle_family
...
def validate_open_family_judgment(
    ...
    from .all_depth_family_runtime import _open_family

...
from .prime_power_productive_bridge_common import digest, reject, sha, signed_bytes
from .prime_power_productive_bridge_formal import (
    capture_pressure_sources, capture_sources, compile_pressure_sources, compile_sources,
    continuity_holds,
)
from .prime_power_productive_bridge_package import first_policy_failure, preflight_charge, snapshot_package
from .prime_power_productive_bridge_pressure import (
    PRESSURE_AXIOM_ROWS, canonical_pressure_bytes, snapshot_offset_program,
)
from .prime_power_productive_bridge_sources import AXIOM_ROWS, THEOREM_IDS
...
def report_missing_bridge_evidence(prime, integer, program) -> BridgeOpen:
    ...
    from .padic_family_introduction_sources import snapshot_integer
    from .prime_power_productive_bridge_sources import snapshot_program
    try:

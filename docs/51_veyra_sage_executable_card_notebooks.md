...
- `tests/test_veyra_sage_card_examples.py` — all 19 examples, filters, notebook builders, unknown failures.
- `tests/test_veyra_sage.py` — certificate suite includes `sage_card_examples_passed`.

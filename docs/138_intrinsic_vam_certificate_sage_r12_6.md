...
```bash
python -m pytest -q \
  tests/test_certify_intrinsic_vam.py \
  tests/test_veyra_sage_intrinsic_vam.py \
  tests/test_certify.py \
  tests/test_veyra_sage_api_index.py \
  tests/test_essence_core.py::test_essence_report_does_not_eagerly_replay_expensive_summary
```

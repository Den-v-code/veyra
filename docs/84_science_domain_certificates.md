...
|---|---|---|
| Finite science rows | `src/core/science_certificates.py` | `science_domain_certificates` |
| Certificate hook | `src/core/certify_science.py` | `certify_science_domain_certificates()` |
| Tests | `tests/test_science_certificates.py` | 6 targeted tests |

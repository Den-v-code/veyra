...
**Implementation:** `src/core/quantum_gate_identities.py`, `src/core/certify_quantum_gates.py`.
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_quantum_gate_identities.py tests/test_quantum_baselines.py tests/test_certify.py

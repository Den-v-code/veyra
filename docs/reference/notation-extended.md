...
| `Δ(p)`; `F♯q`; `D_F(q)`; `R_F(q)`; `S_{F,G}(q)`; `Cr_O(x,y)`; `CB_O(γ)` | R16 distinction relation, pullback, greatest admitted descent, typed residual, compositional synergy, minimal crest, and ordered crest braid | DEF-414–425 / THM-R16-001–003 |

...
This closes the narrow F4 blocker from `102_foundational_gap_audit.md`: native Veyra objects now exist as Python runtime objects before school/classical shadows are derived.
...
- F5 now has a first paired benchmark ledger in `105_classical_benchmark_ledger_f5.md`; expand it before claiming advantage.

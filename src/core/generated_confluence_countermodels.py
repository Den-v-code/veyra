...
def local_nonterminating_countermodel() -> NonterminatingCountermodel:
    ...
    from .generated_confluence_common import digest
...
def _carry_probe(prime: int, precision: int) -> CarryNormalizationProbeRow:
    from .generated_confluence_runtime import generated_finite_confluence, local_join_cell
    from .generated_confluence_paths import branch_targets, generated_local_peaks, generated_reachable
    from .generated_confluence_source import continuation_edge, continuation_state, ranked_continuation_system
    from .generated_confluence_types import GeneratedConfluenceStatus, StateRank

...
def school_topic_coverage_rows() -> tuple[SchoolTopicCoverage, ...]:
    ...
    result = (
        SchoolTopicCoverage(
            ...
            "tests/test_balance_ratio.py", "facade:VeyraRatios", "covered",
        ...
        SchoolTopicCoverage(
            ...
            "tests/test_equation.py", "algebra.linear_solution", "covered",
        ...
        SchoolTopicCoverage(
            ...
            "a claimed root with nonzero residual is blocked", "tests/test_polynomial.py",
        ...
        SchoolTopicCoverage(
            ...
            "negative or overlarge choice indices are invalid", "tests/test_depth_packs.py",
        ...
        SchoolTopicCoverage(
            ...
            "domain/kind mismatch blocks inference", "tests/test_transformer.py",
        ...
        SchoolTopicCoverage(
            ...
            "jump discontinuity blocks sampled-continuity witness", "tests/test_change.py",
        ...
        SchoolTopicCoverage(
            ...
            "nonmatching triangle signature blocks congruence", "tests/test_geometry_theorems.py",
        ...
        SchoolTopicCoverage(
            ...
            "missing dependency prevents stable export", "tests/test_theorem_registry.py",
        ...
        SchoolTopicCoverage(
            ...
            "noncyclic phase witness blocks period claim", "tests/test_cyclic_probability_stats.py",
        ...
        SchoolTopicCoverage(
            ...
            "tests/test_depth_packs.py", "probability.union", "covered",
        ...
        SchoolTopicCoverage(
            ...
            "tests/test_depth_packs.py", "statistics.variance_shift", "covered",
        ...
        SchoolTopicCoverage(
            ...
            "tests/test_trigonometry_identities.py", "trig.identity_seed", "seeded",
        ...
        SchoolTopicCoverage(
            ...
            "tests/test_calculus_depth.py", "analysis.calculus_depth", "seeded",
        ...
        SchoolTopicCoverage(
            ...
            "tests/test_statistics_inference.py", "statistics.inference_seed", "seeded",
        ...
        SchoolTopicCoverage(
            ...
            "tests/test_linear_algebra_seed.py", "linear_algebra.matrix_seed", "seeded",

"""Externally reviewed deterministic Lean object records for R12.5."""
...
_EXPECTED_R12_5_OBJECT_ROWS = (
    ...
    ("lean_observer_core", (
        "VeyraObserverCore.olean", 1582528,
        "aee3e69a1ba2a1b580efd3da0a2483a8eee132b29e3cc06227714bdf1b6ea0b9",
    )),
    ("lean_observer_proof", (
        "VeyraObserverProof.olean", 171064,
        "3e93f940cbf342f8bef8e70af967379020f8b157f8dd3fc66b608de9be4b6055",
    )),
    ("lean_intrinsic_vam", (
        "VeyraIntrinsicVamBridge.olean", 1912864,
        "dd997757c3dedfb02abfd9c7341186bac107646fb9a5a5c2b6f4b664250e0df0",
    )),
)
EXPECTED_R12_5_OBJECTS = MappingProxyType(dict(_EXPECTED_R12_5_OBJECT_ROWS))

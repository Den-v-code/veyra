...
|---|---|---|
| Finite model diagnostics | `src/core/model_diagnostics.py` | `model_diagnostics` |
| Certificate hook | `src/core/certify_science.py` | `certify_model_diagnostics()` |
| Tests | `tests/test_model_diagnostics.py` | 6 targeted tests |

...
- `tests/test_veyra_sage_proofs.py` — summary, domain index, dependency queries, card checks, curriculum paths.
- `tests/test_veyra_sage.py` — certificate suite includes `sage_proof_graph_passed`.

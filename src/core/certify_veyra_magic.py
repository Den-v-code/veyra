...
from .veyra_magic import VEYRA_MAGIC_THESIS, magic_audit_checklist, magic_audit_summary
from .observer_synthesis_parity import observer_synthesis_summary, strict_observer_class_certificate

...
**Implementation:** `src/core/language_span.py`.
**Tests:** `tests/test_core_language_spans.py`.
...
```bash
PYTHONDONTWRITEBYTECODE=1 python3 -m pytest -q tests/test_core_language_spans.py tests/test_core_language.py tests/test_certify.py
```

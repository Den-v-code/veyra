...
import logging
from .transport_coherence_common import digest, exact_shape, reject
from .transport_coherence_package import snapshot_package
from .transport_coherence_paths import boundary_digest, paths_equivalent, replay_path
from .transport_coherence_types import CofinalBoundaryReconciliation, GeneratedTransportFiller, TransportPackage
...
def _snapshot_generated_filler(package: TransportPackage, raw: GeneratedTransportFiller) -> GeneratedTransportFiller:
    ...
    from .transport_coherence_common import exact_digest

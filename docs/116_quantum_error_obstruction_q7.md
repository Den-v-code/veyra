...
**Implementation:** `src/core/quantum_error_obstructions.py`, `src/core/certify_quantum_obstructions.py`.
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_quantum_error_obstructions.py tests/test_quantum_baselines.py tests/test_certify.py

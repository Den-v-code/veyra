...
- `tests/test_veyra_sage_refutations.py` — seven refutations, filters, notebooks, unknown failures.
- `tests/test_veyra_sage.py` — certificate suite includes `sage_refutations_passed`.

...
PORTABLE_TESTS = (
    ...
    "tests/test_prime_power_observer_genesis_p3og_autonomous_tick.py",
    "tests/test_prime_power_observer_genesis_p3og_autonomous_tick_exhaustive.py",
    "tests/test_prime_power_observer_genesis_p3og_native_formation_v2.py",
    "tests/test_prime_power_observer_genesis_p3og_native_formation_resource.py",
    "tests/test_prime_power_observer_genesis_p3og_formation_history_v2.py",
    "tests/test_prime_power_observer_genesis_p3og_formation_contract_split.py",
    ...
    "tests/test_prime_power_observer_genesis_p3og_semantic_formation_history_v3.py",
    "tests/test_prime_power_observer_genesis_p3og_semantic_ablation.py",
    "tests/test_prime_power_observer_genesis_p3og_matched_post_closure.py",
    ...
    "tests/test_prime_power_observer_genesis_p3og_semantic_boundary_dynamics.py",
    "tests/test_prime_power_observer_genesis_p3og_residue_aware_tick_v2.py",
    "tests/test_prime_power_observer_genesis_p3og_residue_causal_effect.py",

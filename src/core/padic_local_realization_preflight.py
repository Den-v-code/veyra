...
from .padic_local_realization_common import exact_digest, exact_shape, reject
from .padic_local_realization_formal import _instance
...
def _policy(value: object) -> N34Policy:
    ...
    from .padic_local_realization_sources import policy

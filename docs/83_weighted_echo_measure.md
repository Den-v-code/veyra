...
|---|---|---|
| Finite weighted measure rows | `src/core/weighted_measure.py` | `weighted_echo_measure` |
| Certificate hook | `src/core/certify_weighted_measure.py` | `certify_weighted_echo_measure()` |
| Tests | `tests/test_weighted_measure.py` | 6 targeted tests |

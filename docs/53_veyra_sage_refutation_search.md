...
- `tests/test_veyra_sage_refutation_search.py` — reports, positive/blocked candidates, filters, notebooks, unknown failures.
- `tests/test_veyra_sage.py` — certificate suite includes `sage_refutation_search_passed`.

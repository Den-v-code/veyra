...
**Implementation:** `src/core/phase_equations.py`, `src/core/certify_phase_equations.py`.
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_phase_equations.py tests/test_certify.py tests/test_essence_core.py tests/test_veyra_sage_essence.py tests/test_veyra_sage.py

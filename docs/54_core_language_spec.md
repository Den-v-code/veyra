...
**Implementation:** `src/core/language.py`.
**Tests:** `tests/test_core_language.py`.
...
```bash
PYTHONDONTWRITEBYTECODE=1 python3 -m pytest -q tests/test_core_language.py tests/test_certify.py
```

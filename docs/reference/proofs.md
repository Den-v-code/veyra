...
Its manifest binds ten sources, 94 declarations (48 headlines), imports,
...
coordinates. T008 fixes the current executable fixture literals and is independently
cross-checked against a fresh Python complete-history replay; this remains a
bounded continuity checkpoint, not Python-byte equivalence, full DEF-OG-009,

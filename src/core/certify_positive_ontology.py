...
from .infinity_prefix import periodic_prefix_window, prefix_alphabet, prefix_stage
from .observer_patch_atlas import triangle_counterexample
from .positive_ontology import (
...
from .positive_ontology_boundaries import (
...
from .positive_ontology_facets import ontology_facet_report

...
**Implementation:** `src/core/quantum_topology.py`, `src/core/certify_quantum_topology.py`.
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_quantum_topology.py tests/test_certify.py

...
**Implementation:** `src/core/quantum_baselines.py`, `src/core/certify_quantum_baselines.py`.
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_quantum_baselines.py tests/test_certify.py

...
- `tests/test_veyra_sage_notebooks.py` — domains, specs, geometry shape, invalid-domain failure, all-domain generation.
- `tests/test_veyra_sage.py` — certificate suite includes `sage_domain_notebooks_passed`.

...
P3N6_MANIFEST_ROOT_V1 = "487f985ed162b764fb683cc5098c646f005d5d84075d4571192cb76930fd218c"
...
def _modules() -> dict[str, object]:
    ...
    if name not in sys.modules:
        ...
        package.__path__ = [str((Path(__file__).parents[1] / "src/core").resolve())]
        sys.modules[name] = package
    names = (
        "padic_completion", "padic_family_introduction",
...
def _packages(modules: dict[str, object]) -> tuple[object, object]:
    ...
    completion = modules["padic_completion"]
    family = modules["padic_family_introduction"]
...
def test_canonical_manifest_root_is_reproducible() -> None:
    ...
    paths = (
        ...
        "tests/test_prime_power_unbounded_p3n6_fifth_repair.py",
        "tests/test_prime_power_unbounded_p3n6_hardening.py",
        "tests/test_prime_power_unbounded_p3n6_positive.py",
        "tests/test_prime_power_unbounded_p3n6_sources.py",
    )
    rows = []
    for path in paths:

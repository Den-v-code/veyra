...
PYTHONDONTWRITEBYTECODE=1 python3 -m pytest -q \
  tests/test_core_language_generated_fuzz.py \
  tests/test_core_language_fuzz.py tests/test_certify.py \
  tests/test_veyra_sage_language.py tests/test_veyra_sage.py
```

...
**Implementation:** `src/core/veyra_magic.py`, `src/core/observer_synthesis.py`, `src/core/observer_synthesis_parity.py`, `src/core/certify_veyra_magic.py`.
...
```bash
PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=. python3 -m pytest -q tests/test_veyra_magic.py tests/test_certify.py

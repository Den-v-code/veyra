...
**Implementation:** `src/core/language.py`, `src/core/proof_discipline.py`, `veyra_sage/proof_discipline.py`.
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_core_language.py tests/test_proof_discipline.py tests/test_veyra_sage_proof_discipline.py tests/test_certify.py tests/test_veyra_sage.py
```

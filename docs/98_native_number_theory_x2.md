...
**Implementation:** `src/core/native_number.py`, `src/core/certify_native_number.py`, `veyra_sage/number_theory.py`.
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_native_resonance_number.py tests/test_veyra_sage_number_theory.py tests/test_certify.py tests/test_veyra_sage.py
```

...
**Implementation:** `src/core/statistics_concentration.py`, `src/core/certify_statistics_concentration.py`.
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_statistics_concentration.py tests/test_certify.py tests/test_essence_core.py tests/test_veyra_sage_essence.py tests/test_veyra_sage.py

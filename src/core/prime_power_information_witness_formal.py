...
from .prime_power_information_witness_sources import snapshot_theorem_source
from .prime_power_information_witness_types import N6WTheoremSourceV1
...
def snapshot_theorem_source_source() -> N6WTheoremSourceV1:
    ...
    from .prime_power_information_witness_sources import theorem_source

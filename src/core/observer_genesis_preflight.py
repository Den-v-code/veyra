"""Typed all-bound preflight before any P1-E1 BFS or evidence replay."""

from __future__ import annotations

import logging

from .observer_genesis_digest import encoded_request_bytes, refusal_digest, request_digest

...
from .padic_local_realization_common import digest, exact_shape, reject
from .padic_local_realization_sources import all_depth_source, policy, theorem_source

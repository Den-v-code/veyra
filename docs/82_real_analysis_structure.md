...
|---|---|---|
| Finite real-analysis rows | `src/core/real_analysis_structure.py` | `real_analysis_structure` |
| Certificate hook | `src/core/certify_real_analysis.py` | `certify_real_analysis_structure()` |
| Tests | `tests/test_real_analysis_structure.py` | 5 targeted tests |

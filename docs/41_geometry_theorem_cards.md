...
Implemented in `src/core/geometry_theorems.py`:
...
Tests in `tests/test_geometry_theorems.py` verify right and blocked Pythagorean cards, SSS/SAS congruence, two/tangent/no line-shell intersections, identity relabeling, and relabel composition.

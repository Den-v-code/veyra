...
- `src/core/observer_gap_topology.py`
- `src/core/certify_observer_gap_topology.py`
- `tests/test_observer_gap_topology.py`

Targeted check:

```bash
pytest -q tests/test_observer_gap_topology.py
ruff check src/core/observer_gap_topology.py tests/test_observer_gap_topology.py
```

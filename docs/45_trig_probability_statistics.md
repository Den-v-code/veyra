...
Implemented in `src/core/cyclic_probability_stats.py`:
...
Tests in `tests/test_cyclic_probability_stats.py` verify phase period/distance/chord symmetry, exact event/complement probability, expectation, mean, variance, and mean balance.

...
**Implementation:** `src/core/formal_export_prep.py`, `src/core/certify_formal_export.py`.
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_formal_export_prep.py tests/test_certify.py
```

...
**Implementation:** `src/core/quantum_stabilizer.py`, `src/core/certify_quantum_stabilizer.py`.
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_quantum_stabilizer.py tests/test_certify.py

...
**Implementation:** `src/core/quantum_qec_echo.py`, `src/core/certify_quantum_qec.py`.
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_quantum_qec_echo.py tests/test_quantum_baselines.py tests/test_certify.py

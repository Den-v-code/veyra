...
**Implementation:** `src/core/quantum_qft_period.py`, `src/core/certify_quantum_qft.py`.
...
```bash
PYTEST_DISABLE_PLUGIN_AUTOLOAD=1 PYTHONPATH=. python3 -m pytest -q tests/test_quantum_qft_period.py tests/test_quantum_baselines.py tests/test_certify.py

...
|---|---|---|
| Scale-memory log rows | `src/core/scale_memory_log.py` | `scale_memory_log` |
| Certificate hook | `src/core/certify_scale_memory.py` | `certify_scale_memory_log()` |
| Practice script | `scripts/scale_memory_log_demo.py` | visible `[1/5]` progress + JSON summary |
| Tests | `tests/test_scale_memory_log.py` | exact/residual/cyclic/obstruction/script checks |

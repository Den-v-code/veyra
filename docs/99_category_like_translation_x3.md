...
**Implementation:** `src/core/category_like.py`, `src/core/certify_category.py`, `veyra_sage/category_like.py`.
...
```bash
PYTHONPATH=. python3 -m pytest -q tests/test_category_like.py tests/test_veyra_sage_category_like.py tests/test_certify.py tests/test_veyra_sage.py
```

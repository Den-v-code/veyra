...
- The realization-transport bridge proves that concrete equality-class labels
  ...
  every generated closure row in the bounded p0 small-total-map sweep
  (three-state target, source sizes 1..3) against production `distinction_set`.
  This is not

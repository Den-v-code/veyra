...
**Implementation:** `src/core/proof_discipline.py`, `veyra_sage/proof_discipline.py`.
...
epistemology split is in `149_positive_ontology_p0.md`, and the standing
non-claim gate remains `102_foundational_gap_audit.md`.
...
See `docs/97_semantic_shadow_certificates.md` for the X1 certificate rule.
...
```bash
PYTHONDONTWRITEBYTECODE=1 python3 -m pytest -q tests/test_proof_discipline.py tests/test_veyra_sage_proof_discipline.py tests/test_certify.py tests/test_essence_core.py tests/test_veyra_sage.py

...
def test_school_topic_gap_rows_mark_remaining_school_to_11_work():
    ...
    assert by_id["calculus-depth"].test_path == "tests/test_calculus_depth.py"
    assert by_id["trigonometry-identities"].test_path == "tests/test_trigonometry_identities.py"
    assert by_id["vectors-matrices"].status == "seeded"
    assert by_id["vectors-matrices"].test_path == "tests/test_linear_algebra_seed.py"
    ...
    assert by_id["statistics-inference"].test_path == "tests/test_statistics_inference.py"

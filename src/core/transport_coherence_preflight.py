...
import logging
from .generated_confluence_types import ContinuationEdge, ContinuationState, RankedContinuationSystem, StateRank
from .transport_coherence_common import exact_shape, reject
